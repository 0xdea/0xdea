...
I write code in Rust, C, Assembly, Python, JavaScript, Java, C++, Go, Perl, Shell, and more... My personal homepage and playground is [0xdeadbeef.info](https://0xdeadbeef.info/).
